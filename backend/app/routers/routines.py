...
from app.services.routine_service import create_routine, get_user_routines, get_routine_detail, update_routine, delete_routine
...
def get_one_routine(
    ...
    return get_routine_detail(db, user.id, id)
